...
exports.run = function(client, message, args) {
  ...
  let embedd = new Discord.RichEmbed().setDescription(
    ` <a✔️756946179530424541> | **Tebrikler!** ${botisim} **adlı botun sertifika aldı. Sertifika rolleri verildi** \n\n  🔏 | **Onaylayan yetkili =** ${yetkili} `
  );
  sahip.send(embedd);
  let embed2 = new Discord.RichEmbed()
    .setColor("#5fbf00")
    .setDescription(
      ` <a✔️756946179530424541> | ${sahip} **adlı kişinin** ${botisim} **adlı botu sertifika aldı.** \n\n  🔏 | **Onaylayan yetkili =** ${yetkili} `
    );
